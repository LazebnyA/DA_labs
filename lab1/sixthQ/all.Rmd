...
#ggsave("lab1/sixthQ/img/phys_health_ment_age_grouped_scatter.jpg", plot = last_plot(), width = 8, height = 6, dpi = 300)
```
...
#ggsave("lab1/sixthQ/img/phys_health_age_grouped_bar.jpg", plot = last_plot(), width = 8, height = 6, dpi = 300)
```
```{r}
only_diabets %>%
  group_by(Age) %>%
...
#ggsave("lab1/sixthQ/img/ment_health_age_grouped_bar.jpg", plot = last_plot(), width = 8, height = 6, dpi = 300)
```
```{r}
...
saveWidget(scatter_plot, file = "img/3d_scatter_plot_Ment_Phys_Age_grouped.html")
