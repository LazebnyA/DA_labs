...
data <- read.csv("G:\\Інші комп’ютери\\Мій пристрій Ноутбук\\синхронізовані документи\\навчання\\університет\\3-й курс, 2-й семестр\\аналіз даних\\DA_labs-main\\prepared_data.csv")
