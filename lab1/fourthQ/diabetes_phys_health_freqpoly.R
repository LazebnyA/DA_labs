...
ggplot(diabetes_true, aes(x = PhysHlth)) +
  geom_freqpoly() +
  scale_y_continuous(labels = scales::comma) +
  labs(title = "PhysHlth Distribution among Diabetics",
       x = "PhysHlth",
       y = "Frequency / Density") +
  theme_minimal()


ggsave("lab1/fourthQ/img/diabetes_phys_health_freqpoly.jpg", plot = last_plot(), width = 8, height = 6, dpi = 300)
